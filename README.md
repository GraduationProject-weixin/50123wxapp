...
# 50123wxapp在线订餐系统的设计与实现+springboot

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1BPtKekEv3?p=126)
...
|baozhuang|varchar(200)|是|*NULL*|包装|
...
|yujishizhang|varchar(200)|是|*NULL*|预计时长|
|peisongzhuangtai|varchar(200)|是|*NULL*|配送状态|
...
|songcandizhi|varchar(200)|是|*NULL*|送餐地址|
...
|shuliang|varchar(200)|是|*NULL*|数量|
|zongjine|varchar(200)|是|*NULL*|总金额|
|xiadanshijian|varchar(200)|是|*NULL*|下单时间|
